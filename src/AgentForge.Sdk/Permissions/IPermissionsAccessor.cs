...
namespace Bennewitz.Ninja.AgentForge.Sdk.Permissions;

/// <summary>
/// Strongly-typed accessor for the <c>permissions</c> block of Claude Code
/// settings. Mutations write to the client's
/// <see cref="IAgentConfigClient.DefaultScope"/> unless overridden via the
/// generic <see cref="IAgentConfigClient.SetValue{T}(string, T, ConfigScope)"/>
/// escape hatch.
/// </summary>
/// <remarks>
...
public interface IPermissionsAccessor
{
    ...
    /// targets <see cref="IAgentConfigClient.DefaultScope"/>.
    /// </summary>
    ...
    /// Setter targets <see cref="IAgentConfigClient.DefaultScope"/>; pass
