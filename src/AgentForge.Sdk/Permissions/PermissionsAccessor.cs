...
/// <see cref="AgentConfigClientCore.GetEffectiveNode"/> for merged views and
/// <see cref="AgentConfigClientCore.GetScopeValue"/> for scope-targeted
...
internal sealed class PermissionsAccessor : IPermissionsAccessor
{
    ...
    public PermissionsAccessor(AgentConfigClientCore client)
    {
        _client = client;
    }
