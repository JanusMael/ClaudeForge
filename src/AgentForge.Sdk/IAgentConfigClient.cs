...
/// </para>
/// </remarks>
public interface IAgentConfigClient : IDisposable
{
    // ── Lifecycle ──────────────────────────────────────────────────────────
    ...
    // implementers (and test fakes) keep compiling; AgentConfigClientCore
...
public enum ClientChangeKind
{
    ...
    /// <summary>The workspace was persisted to disk via <see cref="IAgentConfigClient.SaveAsync(bool, CancellationToken)"/>.</summary>
    Saved,

    /// <summary>The workspace was reloaded from disk via <see cref="IAgentConfigClient.ReloadAsync"/>.</summary>
    Reloaded,
}

/// <summary>
/// Payload for <see cref="IAgentConfigClient.Changed"/>.
/// </summary>
