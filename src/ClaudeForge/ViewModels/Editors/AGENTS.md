...
> Enum, StringArray) live in the `Bennewitz.Ninja.ScopedEditors.ViewModels` package and
...
Sequence in the base class (`PropertyEditorViewModel`, package `Bennewitz.Ninja.ScopedEditors.ViewModels`):
