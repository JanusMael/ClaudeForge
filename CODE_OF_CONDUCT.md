...
ClaudeForge project a harassment-free experience for everyone, regardless
...
requests, discussions, and any other forum maintained by the project — and
also applies when an individual is officially representing the community in
public spaces (using an official project email address, posting via an
...
reported to the maintainers at **bbennewitz@gmail.com** with the subject line
`[ClaudeForge CoC]`. All complaints will be reviewed and investigated
