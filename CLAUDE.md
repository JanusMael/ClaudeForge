...
| Avalonia behaviours that cost us time, with measurements | [XamlQuality's `avalonia-gotchas.md`](https://github.com/JanusMael/Bennewitz.Ninja.XamlQuality/blob/main/docs/avalonia-gotchas.md) |
