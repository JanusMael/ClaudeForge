...
<#
.SYNOPSIS
    FALLBACK winget submission for one app. The normal release does NOT run this —
    sign-release.ps1 already submits. Requires -Force.
...
.EXAMPLE
    ...
    .\Resubmit-Winget.ps1 -App OpenCodeForge -Version 2026.4.100 -Force
#>
[CmdletBinding()]
param(
