...
public sealed class FootprintCatalogTests
{
    ...
    public void DefaultCategory_IsStillTheFirstCategory()
    {
        ...
        Assert.Equal(FootprintCategory.SessionTranscripts, default(FootprintCategory));
    }
    ...
    public void CategoriesFromTheDefaultCatalog_EqualTheStatics()
    {
        ...
        Assert.Equal(FootprintCategory.Todos, FootprintCatalog.Default.CategoryAt(5));
        Assert.Equal(FootprintCategory.SessionMetadata, FootprintCatalog.Default.CategoryAt(1));
    }
    ...
    public void ACategoryFromAnotherCatalog_IsNotEqualToADefaultOne()
    {
        ...
        MessageAssert.NotEqual(FootprintCategory.SessionTranscripts, other.CategoryAt(0),
    ...
    public void DefaultCatalog_IdsAreStable()
    {
        ...
        Assert.Equal(expected, FootprintCategory.All.Select(c => c.Id).ToArray());
    }
    ...
    public void SessionMetadata_CoversThreeDirectories_ButRevealsTheirParent()
    {
        ...
        Assert.Equal(3, definition.Sources.Count);
    ...
    public void OnlySessionTranscripts_IsExcludedFromTheStandardBackup()
    {
        ...
        Assert.Equal(new[] { FootprintCategory.SessionTranscripts }, excluded);
    }
    ...
    public void ASourceNamingAnUnsuppliedRoot_ResolvesToNull_RatherThanThrowing()
    {
        ...
        Assert.Null(FootprintSource.Directory("state", "locks").Resolve(roots));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() => _ = new FootprintCatalog([]));
    }

    [Fact]
    public void TryGetById_FindsACategory_AndReturnsNullForAnUnknownId()
    {
        Assert.Equal(FootprintCategory.Todos, FootprintCatalog.Default.TryGetById("todos"));
        MessageAssert.Null(FootprintCatalog.Default.TryGetById("Todos"), "Ids are ordinal machine keys.");
        Assert.Null(FootprintCatalog.Default.TryGetById("no-such-category"));
    }
}
